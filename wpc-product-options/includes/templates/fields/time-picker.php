...
<div class="wpcpo-item-line">
    ...
    <select name="wpcpo-fields[<?php echo esc_attr( $this->field_id ); ?>][format]">
        <option value="g:i a" <?php selected( $this->get_field_value( 'format' ), 'g:i a' ); ?>><?php echo date_i18n( 'g:i a' ); ?></option>
        <option value="g:i A" <?php selected( $this->get_field_value( 'format' ), 'g:i A' ); ?>><?php echo date_i18n( 'g:i A' ); ?></option>
        <option value="H:i" <?php selected( $this->get_field_value( 'format' ), 'H:i' ); ?>><?php echo date_i18n( 'H:i' ); ?></option>
    </select>
</div>
<div class="wpcpo-item-line">
    <label>
